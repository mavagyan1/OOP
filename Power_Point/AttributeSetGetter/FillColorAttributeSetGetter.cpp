#include "FillColorAttributeSetGetter.hpp"
#include "../items/Item.hpp"
#include <stdexcept> //std::runtime_error
#include <sstream> //std::istringstream

 void FillColorAttributeSetGetter::setAttribute(Item* item, std::string rgbStream) {
...
int FillColorAttributeSetGetter::getAttribute(Item* item) const {
